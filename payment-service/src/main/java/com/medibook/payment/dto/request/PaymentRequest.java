...
//     @Pattern(
//             regexp = "CARD|UPI|NETBANKING|WALLET|CASH",
//             message = "Payment method must be CARD, UPI, NETBANKING, WALLET, or CASH"
//     )
//     private String paymentMethod;
        @Pattern(
                regexp = "CARD|UPI|NETBANKING|WALLET|CASH|ONLINE|RAZORPAY|COD",
                message = "Payment method must be CARD, UPI, NETBANKING, WALLET, CASH, ONLINE, RAZORPAY, or COD"
        )
        private String paymentMethod;
